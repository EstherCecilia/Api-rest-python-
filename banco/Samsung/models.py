...
conectedSintomas = Table('conectedSintoma',Base.metadata, 
               Column('id_sessao', Integer, ForeignKey('sessoes.id')),
               Column('id_sintoma', Integer, ForeignKey('sintomas.id'))
    )

conectedTransmicaos = Table('conectedTransmicao',Base.metadata, 
               Column('id_sessao', Integer, ForeignKey('sessoes.id')),
               Column('id_transmicao', Integer, ForeignKey('transmicaos.id'))
    )

conectedPrevencaos = Table('conectedPrevencao',Base.metadata, 
               Column('id_sessao', Integer, ForeignKey('sessoes.id')),
               Column('id_prevencao', Integer, ForeignKey('prevencoes.id'))
    )
...
class Sessao(Base):
    ...
    sintoma = relationship('Sintomas', secondary=conectedSintomas, backref=backref('conectedSintomass', lazy='dynamic'))
    prevencao = relationship("Prevencoes", secondary=conectedPrevencaos, backref=backref('conectedPrevencaoss', lazy='dynamic'))
    transmicao = relationship("Transmicaos", secondary=conectedTransmicaos, backref=backref('conectedTransmicaoss', lazy='dynamic'))
